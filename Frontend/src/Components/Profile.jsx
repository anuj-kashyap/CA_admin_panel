...
const Profile = () => {
  ...
  return (
    <div>
        <Navbar/>
    <div className="flex bg-[rgb(0,6,36)] bg-gradient-to-r from-[rgba(0,6,36,1)] to-[rgba(14,119,212,0.89)] to-75% justify-center min-h-screen p-20 items-center">
      <div className=" p-10 bg-[rgb(0,6,36)] bg-gradient-to-r from-[rgba(0,6,36,1)] to-[rgba(14,119,212,0.89)] to-75% pt-10 rounded-3xl outline outline-4 bg-opacity-50 outline-white shadow-lg shadow-white h-full w-full max-w-xl">
