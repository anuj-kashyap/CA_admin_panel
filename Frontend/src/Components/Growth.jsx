  ...
  return (
    <div className="p-4  min-h-screen text-white">
      <div className="grid grid-cols-1  lg:grid-cols-2 gap-4">
        <div className="lg:col-span-1 bg-gray-700  shadow-xl shadow-white  ml-80 max-w-3xl my-10 p-4 rounded-xl">
        ...
        <div className=" p-4 mx-20 mt-10 shadow-xl bg-gray-700 shadow-white rounded-md">
          ...
          <div className="mt-4 bg-white p-2 rounded-md text-center">
            <span className="block text-xl text-black">Declined</span>
            <span className="block text-2xl text-black">51</span>
            <span className="block text-blue-500">17.0%</span>
          </div>
        </div>
        <div className="lg:col-span-1 shadow-xl shadow-white  pt-20 ml-80 my-10 bg-gray-700 p-4 rounded-lg">
          <h2 className="text-xl font-semibold mb-4">Revenue</h2>
          <div>
            <Line data={revenueData} options={{ plugins: { legend: { display: false } } }} />
          </div>
        </div>
        <div className="bg-gray-700 ml-16 shadow-xl shadow-white mr-10 p-4 my-10 rounded-lg">
