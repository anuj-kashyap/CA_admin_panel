...
const User = () => {
  ...
  return (
    ...
    <div>
      ...
      <div className="bg-[rgb(0,6,36)] bg-gradient-to-r from-[rgba(0,6,36,1)] to-[rgba(14,119,212,0.89)] to-75% min-h-screen p-4 text-center mx-auto pt-8">
      <div className="text-center mx-auto pt-8">

        <h1 className='inline-block text-white  text-3xl md:text-7xl'>Users</h1>
      </div>
      <div className="flex pt-20 justify-center min-h-screen">
        {/* Main Content */}
        <div className="w-1/2 p-4 text-center">
          <table className="min-w-full outline outline-white rounded-xl  shadow-lg shadow-white">
            <thead>
